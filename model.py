...
def generate_model(factors = ['Restaurant Bookings','Vic Employment','Revenue Hours', 'BC Vaccination Rate','Season 1','Season 2','Season 3','Average Precip','Average Temperature'],y_var = 'Total Boardings'):
    ...
    # splitting the data
    x_train, x_test, y_train, y_test = train_test_split(x, y, test_size = 0.15, random_state = random.randint(1,10))
