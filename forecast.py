...
factors = ['SD61 Season','Total Calculated Revenue Hours','Restaurant Bookings','Vic Employment', 'BC Vaccination Rate','Season 1','Season 2','Season 3','Average Temperature','Average Precip']
...
def long_term_forecast(start_week,num_weeks): #run point_in_time_forecast for each week in the future and plot the results
    ...
    dump_to_excel(means,col="B")
    dump_to_excel(min,col="C")
    dump_to_excel(max,col="D")
