...
def point_in_time_forecast(week):
...
def long_term_forecast(start_week,num_weeks):
    means = []
    min = []
    max = []
    x = []
    ...
    return
#point_in_time_forecast(60)
long_term_forecast(53,105)
#dump_to_excel(point_in_time_forecast(53+23))
...
fig = px.histogram(point_in_time_forecast(53*2+23),histnorm = 'percent',nbins=40,labels={'value':'Weekly Ridership'})
annotations = [(dict(xref='paper', yref='paper', x=0.5, y=1.05,
                          xanchor='center', yanchor='bottom',
